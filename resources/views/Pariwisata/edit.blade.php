...
<div class="d-sm-flex align-items-center flex-column justify-content-between mb-4">
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('pariwisata.update', $destination->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lokasi" name="lokasi" class="form-control" 
                                           value="{{ old('lokasi', $destination->lokasi) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="service" name="service" class="form-control" 
                                              placeholder="Masukkan layanan">{{ old('service', $destination->service) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="map">Koordinat Google Maps</label>
                                    <textarea id="map" name="map" class="form-control" 
                                              placeholder="Latitude, Longitude">{{ old('map', $destination->map) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="content">Konten</label>
                                    <textarea id="content" name="content" class="form-control" rows="3" 
                                              placeholder="Masukkan konten">{{ old('content', $destination->content) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" id="imageberita" name="imageberita" class="form-control" 
                                           value="{{ old('imageberita', $destination->imageberita) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" id="imagedestination" name="imagedestination" class="form-control" 
                                           value="{{ old('imagedestination', $destination->imagedestination) }}" 
