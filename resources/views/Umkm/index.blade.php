    ...
    <div class="destinasi">
        <div class="containerr">
            ...
            <div class="destinasi-grid">
                @foreach ($umkmdestinations as $index => $umkmdestination)
                <div class="background-borderr" data-category="{{ $umkmdestination->category ?? 'Historical' }}">
                    <div class="iconn-9"></div>
                    <div class="destinasi-image">
                        <img src="{{ $umkmdestination->imagedestination }}" alt="{{ $umkmdestination->title }}" />
                    </div>
                    <div class="text-wrapperr-27">{{ $umkmdestination->lokasi }}</div>
                    <div class="text-wrapperr-28">{{ $umkmdestination->title }}</div>
                    <div class="listt-4">
