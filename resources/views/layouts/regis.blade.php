...
<head>
    ...
    <title>Sagala Bandung - Home & Register</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="image-container">
                        <img src="/img/bandung_img/animasi.png" alt="Register Illustration" class="login-image">
                    </div>
                </div>
                        ...
                        <div class="login-card">
                            ...
                            <form action="{{ route('registerProcess') }}" method="POST">
                                ...
                                <div class="text-center mt-3">
                                    ...
                                    <a href="{{ url('/sesi') }}" class="text-decoration-none">Login Disini</a>
                                </div>
                            </form>
                        </div>
                    </div>
